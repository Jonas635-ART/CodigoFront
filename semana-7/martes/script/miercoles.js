...
function obtenerComputadoras() {
    ...
    function crearNodo(computadora) {
      ...
      nodo.innerHTML = `
        <article class="card mb-4">
            <div class="card-body">
                ...
                <p class="card-text">Anio: ${computadora.anio}</p>
      ...
      nodo.querySelector(".js_edit").onclick = function () {
        ...
        const inputAnio = document.querySelector(".js_form_edit .js_anio");
        ...
        inputAnio.value = computadora.anio;
  ...
  */
  ...
  function obtenerValores(form) {
    return {
      ...
      anio: form.querySelector(`.js_anio`).value,
  ...
  function obtenerReferenciasFormulario(form) {
    return {
      ...
      anio: form.querySelector(`.js_anio`),
