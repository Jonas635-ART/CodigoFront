...
{age: 22 };
let objeto3 = Object.assign({},objeto);
objeto.name = "sebas modificado";
objeto.lastname = "yabiku modificado";

console.log("objeto", objeto);
console.log("objeto2", objeto2);
console.log("objeto3", objeto3);

const numerosArray = [0, 1, 2, 3, 4, 5, 6, 7];
const numerosArray2 = [...numerosArray];
const numerosArray3 = [].concat(numerosArray);
